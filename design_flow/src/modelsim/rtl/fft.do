...
add wave -noupdate -radix decimal /fftTestBench/rst
add wave -noupdate -radix decimal /fftTestBench/stall
add wave -noupdate -radix decimal /fftTestBench/stall_out
add wave -noupdate -radix decimal /fftTestBench/dut_fft/comb_stall
...
add wave -noupdate /fftTestBench/dut_fft/rst
add wave -noupdate /fftTestBench/dut_fft/stall
add wave -noupdate /fftTestBench/dut_fft/inst_fifo/clk
add wave -noupdate /fftTestBench/dut_fft/inst_fifo/rst
add wave -noupdate /fftTestBench/dut_fft/inst_fifo/stall_in
add wave -noupdate /fftTestBench/dut_fft/inst_fifo/stall_out
add wave -noupdate /fftTestBench/dut_fft/inst_fifo/clk
